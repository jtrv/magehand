...
- [ ] 1. Finish M4 server + voice client core so the tree compiles: create `src/voice.js`
...
- [ ] 2. M4 UI wiring: dm.html gains Join voice / Start session / End session buttons +
...
- [ ] 3. E2E transcription fixture: script in scratchpad spins a fake whisper-server
...
- [ ] 4. Codex adversarial review of `git diff HEAD~2` (the two feature commits): dispatch
...
- [ ] 5. Docs + cleanup: README "Online play" section (host/caddy/coturn/whisper-server
